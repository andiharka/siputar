<script lang="ts">
  ...
  function incrementHour() { setTime(hours + 1, minutes, seconds); }
  function decrementHour() { setTime(hours - 1, minutes, seconds); }
  function incrementMinute() { setTime(hours, minutes + 1, seconds); }
  function decrementMinute() { setTime(hours, minutes - 1, seconds); }
  function incrementSecond() { setTime(hours, minutes, seconds + 1); }
  function decrementSecond() { setTime(hours, minutes, seconds - 1); }
  ...
  <div class="editor">
    ...
    <div class="field">
      ...
      <div class="time-picker">
        <!-- Hours -->
        <div class="time-col">
          <button class="spin-btn" type="button" onclick={incrementHour} aria-label="Increase hour" tabindex="-1">
          ...
          <input
            ...
            aria-label="Hours"
          />
          <button class="spin-btn" type="button" onclick={decrementHour} aria-label="Decrease hour" tabindex="-1">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
          </button>
          <span class="time-unit-label">HH</span>
        </div>
        ...
        <!-- Minutes -->
        <div class="time-col">
          <button class="spin-btn" type="button" onclick={incrementMinute} aria-label="Increase minute" tabindex="-1">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>
          </button>
          <input
            class="time-input"
            ...
            aria-label="Minutes"
          />
          <button class="spin-btn" type="button" onclick={decrementMinute} aria-label="Decrease minute" tabindex="-1">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
          </button>
          <span class="time-unit-label">MM</span>
        </div>
        ...
        <!-- Seconds -->
        <div class="time-col">
          <button class="spin-btn" type="button" onclick={incrementSecond} aria-label="Increase second" tabindex="-1">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>
          </button>
          <input
            class="time-input"
            ...
            aria-label="Seconds"
          />
          <button class="spin-btn" type="button" onclick={decrementSecond} aria-label="Decrease second" tabindex="-1">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
          </button>
          <span class="time-unit-label">SS</span>
        </div>
      </div>
    </div>
